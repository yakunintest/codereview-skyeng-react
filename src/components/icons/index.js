...
export const TopIcon = ({width, height}) => <svg width={width} height={height} viewBox="0 0 6 5" fill="none"><path d="M1 4L3 2L5 4" stroke="#CACDD8" strokeWidth="1.6" strokeLinecap="round"/></svg>

export const BottomIcon = ({width, height}) => <svg width={width} height={height} viewBox="0 0 6 5" fill="none"><path d="M5 1L3 3L1 0.999999" stroke="#CACDD8" strokeWidth="1.6" strokeLinecap="round"/></svg>
